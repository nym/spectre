...
$$.ConstantMap = {"":
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_12 = f;
  $.forEach(this._lib1_keys, new $.Closure13(this, t1));
 },
 operator$index$1: function(key) {
...
$$.FilteredElementList = {"":
 ...
 get$add: function() { return new $.Closure15(this, 'add$1'); },
...
$$._CssClassSet = {"":
 ...
 clear$0: function() {
  this._modify$1(new $.Closure12());
 },
 addAll$1: function(collection) {
  var t1 = ({});
  t1.collection_1 = collection;
  this._modify$1(new $.Closure11(t1));
 },
 remove$1: function(value) {
  var s = this._read$0();
 ...
 add$1: function(value) {
  var t1 = ({});
  t1.value_1 = value;
  this._modify$1(new $.Closure10(t1));
 },
 contains$1: function(value) {
...
$$._AttributeClassSet = {"":
 ...
 get$$$dom_className: function() { return new $.Closure16(this, '$dom_className$0'); }
};
...
$.enableCodeBlocks = function() {
  for (var t1 = $.iterator($.document().queryAll$1('.method, .field')); t1.hasNext$0() === true; ) {
    ...
    $.add$1(showCode.get$on().get$click(), new $.Closure(t2));
  }
};
